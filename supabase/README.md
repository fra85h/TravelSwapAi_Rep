...
| `20260713040000_fb_messenger_link.sql` | Collegamento identità Messenger↔account TravelSwap: `fb_link_codes` (codice monouso, 15 minuti) e `fb_account_links`, entrambe service-role only. |
