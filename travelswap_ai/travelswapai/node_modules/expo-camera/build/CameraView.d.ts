...
import { CameraCapturedPicture, CameraOrientation, CameraPictureOptions, CameraViewProps, CameraRecordingOptions, CameraViewRef, ScanningOptions, ScanningResult, VideoCodec, AvailableLenses } from 'expo-camera/src/Camera.types';
import { PictureRef } from 'expo-camera/src/PictureRef';
export default class CameraView extends Component<CameraViewProps> {
    ...
    static ConversionTables: {
        [prop: string]: unknown;
        type: Record<keyof import("expo-camera/src/Camera.types").CameraType, import("expo-camera/src/Camera.types").CameraNativeProps["facing"]>;
        flash: Record<keyof import("expo-camera/src/Camera.types").FlashMode, import("expo-camera/src/Camera.types").CameraNativeProps["flashMode"]>;
    };
