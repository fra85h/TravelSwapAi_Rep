...
import { InfoPlist, InterfaceOrientation } from '@expo/config-plugins/build/ios/IosConfig.types.js';
export declare const withOrientation: import("@expo/config-plugins").ConfigPlugin;
