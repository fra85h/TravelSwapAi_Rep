...
import { InfoPlist } from '@expo/config-plugins/build/ios/IosConfig.types.js';
export declare const withVersion: import("@expo/config-plugins").ConfigPlugin;
export declare const withBuildNumber: import("@expo/config-plugins").ConfigPlugin;
