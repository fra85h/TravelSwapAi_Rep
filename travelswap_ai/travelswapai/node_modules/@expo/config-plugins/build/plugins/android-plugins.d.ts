import { ConfigPlugin, ExportedConfigWithProps, Mod } from '@expo/config-plugins/build/Plugin.types.js';
import { Manifest, Paths, Properties, Resources } from '@expo/config-plugins/build/android';
