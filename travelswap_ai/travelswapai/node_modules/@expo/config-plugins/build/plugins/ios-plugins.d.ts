...
import type { ConfigPlugin, Mod } from '@expo/config-plugins/build/Plugin.types.js';
import type { ExpoPlist, InfoPlist } from '@expo/config-plugins/build/ios/IosConfig.types.js';
import type { AppDelegateProjectFile, PodfileProjectFile } from '@expo/config-plugins/build/ios/Paths.js';
