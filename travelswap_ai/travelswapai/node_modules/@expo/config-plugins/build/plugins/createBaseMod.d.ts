import { BaseModOptions } from '@expo/config-plugins/build/plugins/withMod.js';
import { ConfigPlugin, ExportedConfig, ExportedConfigWithProps, ModPlatform } from '@expo/config-plugins/build/Plugin.types.js';
