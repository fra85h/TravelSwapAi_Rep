...
import type { PropertiesItem } from '@expo/config-plugins/build/android/Properties.js';
import type { ConfigPlugin } from '@expo/config-plugins/build/Plugin.types.js';
import { BuildPropertiesConfig, ConfigToPropertyRuleType } from '@expo/config-plugins/build/utils/BuildProperties.types.js';
/**
