import { AndroidManifest } from '@expo/config-plugins/build/android/Manifest.js';
import { ResourceXML } from '@expo/config-plugins/build/android/Resources.js';
import * as Resources from '@expo/config-plugins/build/android/Resources.js';
import { ConfigPlugin, ExportedConfigWithProps } from '@expo/config-plugins/build/Plugin.types.js';
import { ExpoConfigUpdates } from '@expo/config-plugins/build/utils/Updates.js';
