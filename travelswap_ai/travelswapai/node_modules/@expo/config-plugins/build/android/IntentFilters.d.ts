...
import { AndroidManifest, ManifestIntentFilter } from '@expo/config-plugins/build/android/Manifest.js';
type AndroidIntentFilters = NonNullable<Android['intentFilters']>;
export declare const withAndroidIntentFilters: import("@expo/config-plugins").ConfigPlugin;
