...
import * as AndroidPaths from '@expo/config-plugins/build/android/Paths.js';
import { ResourceXML } from '@expo/config-plugins/build/android/Resources.js';
import { ExpoPlist, InfoPlist } from '@expo/config-plugins/build/ios/IosConfig.types.js';
