...
export const translations = {
  ...
  it: {
    ...
    createListing: {
      ...
      activeCapTitle: "Limite annunci attivi raggiunto",
      activeCapMsg: "Hai già {cap} annunci attivi: metti in pausa o elimina qualcuno dei tuoi annunci esistenti prima di pubblicarne uno nuovo.",
      activeCapReactivateMsg: "Le date sono state salvate, ma l'annuncio non torna attivo: hai già {cap} annunci attivi. Metti in pausa o elimina qualcuno, poi riprova.",
  ...
  en: {
    ...
    createListing: {
      ...
      activeCapTitle: "Active listing limit reached",
      activeCapMsg: "You already have {cap} active listings: pause or delete one of your existing listings before publishing a new one.",
      activeCapReactivateMsg: "The dates were saved, but the listing didn't go back to active: you already have {cap} active listings. Pause or delete one, then try again.",
  ...
  es: {
    ...
    createListing: {
      ...
      activeCapTitle: "Límite de anuncios activos alcanzado",
      activeCapMsg: "Ya tienes {cap} anuncios activos: pausa o elimina alguno de tus anuncios existentes antes de publicar uno nuevo.",
      activeCapReactivateMsg: "Las fechas se han guardado, pero el anuncio no vuelve a estar activo: ya tienes {cap} anuncios activos. Pausa o elimina alguno y vuelve a intentarlo.",
