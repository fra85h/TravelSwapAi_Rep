...
export const translations = {
  ...
  it: {
    ...
    esplora: {
      ...
      forYouInfoMsg: "Annunci scelti dall'AI in base a ciò che cerchi e pubblichi. La percentuale di affinità indica quanto un annuncio è in linea con te: più è alta, meglio è.",
      affinity: "Affinità {n}%",
  ...
  en: {
    ...
    esplora: {
      ...
      forYouInfoMsg: "Listings picked by the AI based on what you search for and publish. The affinity percentage shows how well a listing matches you: the higher, the better.",
      affinity: "Affinity {n}%",
  ...
  es: {
    ...
    esplora: {
      ...
      forYouInfoMsg: "Anuncios elegidos por la IA según lo que buscas y publicas. El porcentaje de afinidad indica cuánto encaja un anuncio contigo: cuanto más alto, mejor.",
      affinity: "Afinidad {n}%",
