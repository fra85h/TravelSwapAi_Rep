...
export const translations = {
  ...
  it: {
    ...
    savedScreen: {
      ...
      statusExpired: "Scaduto: la data è passata",
      statusDeleted: "Eliminato da chi l'ha pubblicato",
      statusReserved: "Riservato: c'è una proposta in corso",
      statusPending: "In attesa di conferma",
      statusDraft: "Bozza: non ancora pubblicato",
    ...
    createListing: {
      ...
      checkAiCta: "Check AI",
      checkAiHint: "Se non la lanci, parte comunque da sola alla pubblicazione.",
      review: {
        title: "Pubblico l'annuncio?",
        subtitle: "Un'ultima occhiata a cosa sta per andare online:",
        footnote: "Puoi comunque pubblicare: l'annuncio si mette in pausa o si modifica in qualsiasi momento.",
        publish: "Pubblica",
        back: "Rivedi",
        noPhotos: "Nessuna foto: gli annunci con foto ricevono più proposte.",
        noTrust: "Affidabilità non calcolata: l'annuncio esce senza il badge di verifica.",
        lowTrust: "Affidabilità {score}%: è il numero che vedrà chi guarda l'annuncio.",
        priceHigh: "Prezzo sopra la nostra stima: potrebbe ricevere poche offerte.",
        priceHighPct: "Prezzo circa il {pct}% sopra la nostra stima: potrebbe ricevere poche offerte.",
        dynamicPricing: "Prezzo dinamico attivo: scenderà da solo avvicinandosi alla data.",
        dynamicPricingFloor: "Prezzo dinamico attivo: scenderà da solo fino a {floor}€ avvicinandosi alla data.",
      },
      checkAiCardTitle: "Fatti dare un voto di affidabilità",
      checkAiCardText: "Gli annunci verificati mostrano un badge e vengono scelti più spesso. Controlliamo prezzo, date, tratta e foto: ci vogliono pochi secondi.",
      checkAiNeedsDesc: "Serve la descrizione qui sopra per poter valutare l'annuncio — tocca qui per scriverla.",
      checkAiNeedsDescCta: "Scrivi la descrizione",
      checkAiNeedsDescAlert: "Per verificare l'annuncio serve una descrizione di almeno 10 caratteri. È l'unica parte che il documento non può scrivere al posto tuo: bastano due righe su cosa stai vendendo.",
      descriptionPlaceholderStep2: "Perché lo vendi, com'è il posto a sedere, cosa deve sapere chi lo compra…",
      descriptionMissingHint: "Il documento ha riempito tutto il resto: questa è l'unica parte che può scrivere solo tu, ed è quella che gli acquirenti leggono per primi. Bastano due righe.",
      descriptionStep2Hint: "È il pezzo che il Check AI legge per valutare l'affidabilità dell'annuncio.",
      price: "Prezzo *",
      ...
      photoDeleteFailedTitle: "Foto non eliminata",
      photoDeleteFailedAction: "La foto è ancora sull'annuncio. Riprova fra poco.",
      pnrTakenTitle: "Biglietto già in vendita",
      pnrTakenMsg: "Il codice di prenotazione che hai inserito risulta già su un altro annuncio online. Controlla di averlo copiato bene: se è giusto, quel biglietto è già in vendita e questo annuncio non è stato pubblicato.",
      pnrInvalidTitle: "Codice di prenotazione non valido",
      pnrInvalidMsg: "Ricontrolla il codice di prenotazione sul biglietto: è la sigla di lettere e numeri che identifica la prenotazione. L'annuncio non è stato pubblicato.",
      ...
      errors: {
        ...
        priceDecimals: "Il prezzo può avere al massimo due decimali. Per milleduecento euro scrivi 1200, non 1.200.",
    ...
    editListing: {
      ...
      changedTitle: "L'annuncio è cambiato nel frattempo",
      changedPriceMsg: "Il prezzo è sceso automaticamente a {ora}€ mentre modificavi. Se salvi, torna a {tuo}€.",
      changedGenericMsg: "Qualcosa è stato aggiornato dopo che hai aperto la schermata. Se salvi, le tue modifiche prendono il posto di quelle.",
      changedSaveAnyway: "Salva le mie",
    ...
    legal: {
      ...
      accepting: "Registro l'accettazione…",
      decline: "Non accetto — esci",
      acceptErrorTitle: "Accettazione non registrata",
      acceptError: "Riprova fra poco: nulla è stato salvato, i documenti restano da accettare.",
      openErrorTitle: "Documento non aperto",
      openError: "Puoi leggerlo dal browser: l'indirizzo è lo stesso del sito TravelSwap.",
    ...
    transactionSteps: {
      ...
      waitingOther: "Stai aspettando {name}: la schermata si aggiorna tirando giù.",
      waitingMe: "Tocca a te: il passaggio qui sotto aspetta una tua mossa.",
      waitingBoth: "Serve un gesto da entrambi: finché manca una delle due parti si resta qui.",
      otherParty: "l'altra parte",
  ...
  en: {
    ...
    savedScreen: {
      ...
      statusExpired: "Expired: the date has passed",
      statusDeleted: "Deleted by whoever published it",
      statusReserved: "Reserved: there is an offer under way",
      statusPending: "Waiting for confirmation",
      statusDraft: "Draft: not published yet",
    ...
    createListing: {
      ...
      checkAiCta: "Check AI",
      checkAiHint: "If you skip it, it still runs on its own when you publish.",
      review: {
        title: "Publish the listing?",
        subtitle: "One last look at what's about to go live:",
        footnote: "You can publish anyway: a listing can be paused or edited at any time.",
        publish: "Publish",
        back: "Review",
        noPhotos: "No photos: listings with photos get more offers.",
        noTrust: "Reliability not calculated: the listing goes out without the verification badge.",
        lowTrust: "Reliability {score}%: that's the number buyers will see.",
        priceHigh: "Price above our estimate: it may get few offers.",
        priceHighPct: "Price about {pct}% above our estimate: it may get few offers.",
        dynamicPricing: "Dynamic pricing on: it will drop by itself as the date approaches.",
        dynamicPricingFloor: "Dynamic pricing on: it will drop by itself down to €{floor} as the date approaches.",
      },
      checkAiCardTitle: "Get a reliability score",
      checkAiCardText: "Verified listings show a badge and get picked more often. We check price, dates, route and photos: it takes a few seconds.",
      checkAiNeedsDesc: "The description above is needed to rate this listing — tap here to write it.",
      checkAiNeedsDescCta: "Write the description",
      checkAiNeedsDescAlert: "To verify the listing we need a description of at least 10 characters. It's the one part the document can't write for you: a couple of lines about what you're selling is enough.",
      descriptionPlaceholderStep2: "Why you're selling it, what the seat is like, what the buyer should know…",
      descriptionMissingHint: "The document filled in everything else: this is the only part only you can write, and it's the first thing buyers read. Two lines are enough.",
      descriptionStep2Hint: "This is what Check AI reads to rate the listing's reliability.",
      price: "Price *",
      ...
      photoDeleteFailedTitle: "Photo not deleted",
      photoDeleteFailedAction: "The photo is still on the listing. Try again shortly.",
      pnrTakenTitle: "Ticket already on sale",
      pnrTakenMsg: "The booking code you entered is already on another listing that is online. Check that you copied it correctly: if it is right, that ticket is already on sale and this listing was not published.",
      pnrInvalidTitle: "Invalid booking code",
      pnrInvalidMsg: "Check the booking code on your ticket: it is the string of letters and numbers that identifies the booking. The listing was not published.",
      ...
      errors: {
        ...
        priceDecimals: "The price can have at most two decimals. For one thousand two hundred euro write 1200, not 1.200.",
    ...
    editListing: {
      ...
      changedTitle: "The listing changed in the meantime",
      changedPriceMsg: "The price dropped automatically to €{ora} while you were editing. If you save, it goes back to €{tuo}.",
      changedGenericMsg: "Something was updated after you opened this screen. If you save, your changes replace those.",
      changedSaveAnyway: "Save mine",
    ...
    legal: {
      ...
      acceptErrorTitle: "Acceptance not recorded",
      acceptError: "Try again shortly: nothing was saved, the documents are still to be accepted.",
      openErrorTitle: "Document didn't open",
      openError: "You can read it in your browser: the address is the same as the TravelSwap site.",
    ...
    transactionSteps: {
      ...
      waitingOther: "You're waiting for {name}: pull down to refresh this screen.",
      waitingMe: "It's your turn: the step below is waiting for you.",
      waitingBoth: "It takes both of you: until one side moves, nothing changes here.",
      otherParty: "the other person",
  ...
  es: {
    ...
    savedScreen: {
      ...
      statusExpired: "Caducado: la fecha ya ha pasado",
      statusDeleted: "Eliminado por quien lo publicó",
      statusReserved: "Reservado: hay una propuesta en curso",
      statusPending: "A la espera de confirmación",
      statusDraft: "Borrador: aún no publicado",
    ...
    createListing: {
      ...
      checkAiCta: "Check AI",
      checkAiHint: "Si no la lanzas, se ejecuta igualmente sola al publicar.",
      review: {
        title: "¿Publico el anuncio?",
        subtitle: "Un último vistazo a lo que está a punto de publicarse:",
        footnote: "Puedes publicar igualmente: el anuncio se pausa o se edita en cualquier momento.",
        publish: "Publicar",
        back: "Revisar",
        noPhotos: "Sin fotos: los anuncios con fotos reciben más propuestas.",
        noTrust: "Fiabilidad no calculada: el anuncio sale sin la insignia de verificación.",
        lowTrust: "Fiabilidad {score}%: es el número que verá quien mire el anuncio.",
        priceHigh: "Precio por encima de nuestra estimación: puede recibir pocas ofertas.",
        priceHighPct: "Precio un {pct}% por encima de nuestra estimación: puede recibir pocas ofertas.",
        dynamicPricing: "Precio dinámico activo: bajará solo al acercarse la fecha.",
        dynamicPricingFloor: "Precio dinámico activo: bajará solo hasta {floor}€ al acercarse la fecha.",
      },
      checkAiCardTitle: "Consigue una puntuación de fiabilidad",
      checkAiCardText: "Los anuncios verificados muestran una insignia y se eligen más a menudo. Comprobamos precio, fechas, trayecto y fotos: tarda unos segundos.",
      checkAiNeedsDesc: "Hace falta la descripción de arriba para poder evaluar el anuncio — toca aquí para escribirla.",
      checkAiNeedsDescCta: "Escribe la descripción",
      checkAiNeedsDescAlert: "Para verificar el anuncio hace falta una descripción de al menos 10 caracteres. Es la única parte que el documento no puede escribir por ti: bastan dos líneas sobre lo que vendes.",
      descriptionPlaceholderStep2: "Por qué lo vendes, cómo es el asiento, qué debe saber quien lo compra…",
      descriptionMissingHint: "El documento ha rellenado todo lo demás: esta es la única parte que solo puedes escribir tú, y es lo primero que leen los compradores. Bastan dos líneas.",
      descriptionStep2Hint: "Es lo que Check AI lee para evaluar la fiabilidad del anuncio.",
      price: "Precio *",
      ...
      photoDeleteFailedTitle: "Foto no eliminada",
      photoDeleteFailedAction: "La foto sigue en el anuncio. Inténtalo de nuevo en un momento.",
      pnrTakenTitle: "Billete ya en venta",
      pnrTakenMsg: "El código de reserva que has introducido ya figura en otro anuncio publicado. Comprueba que lo has copiado bien: si es correcto, ese billete ya está en venta y este anuncio no se ha publicado.",
      pnrInvalidTitle: "Código de reserva no válido",
      pnrInvalidMsg: "Revisa el código de reserva en el billete: son las letras y los números que identifican la reserva. El anuncio no se ha publicado.",
      ...
      errors: {
        ...
        priceDecimals: "El precio puede tener como máximo dos decimales. Para mil doscientos euros escribe 1200, no 1.200.",
    ...
    editListing: {
      ...
      changedTitle: "El anuncio ha cambiado mientras tanto",
      changedPriceMsg: "El precio ha bajado automáticamente a {ora}€ mientras editabas. Si guardas, vuelve a {tuo}€.",
      changedGenericMsg: "Algo se ha actualizado después de que abrieras esta pantalla. Si guardas, tus cambios sustituyen a esos.",
      changedSaveAnyway: "Guardar los míos",
    ...
    legal: {
      ...
      acceptErrorTitle: "Aceptación no registrada",
      acceptError: "Inténtalo dentro de un momento: no se ha guardado nada, los documentos siguen pendientes.",
      openErrorTitle: "El documento no se ha abierto",
      openError: "Puedes leerlo en el navegador: la dirección es la misma que la del sitio de TravelSwap.",
    ...
    transactionSteps: {
      ...
      waitingOther: "Estás esperando a {name}: desliza hacia abajo para actualizar la pantalla.",
      waitingMe: "Te toca a ti: el paso de abajo espera un gesto tuyo.",
      waitingBoth: "Hace falta un gesto de ambos: mientras falte una de las dos partes, todo se queda aquí.",
      otherParty: "la otra persona",
